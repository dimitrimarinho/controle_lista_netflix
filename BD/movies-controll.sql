...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=278771387ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=movies-controll&table=movies">`movies-controll`.`movies`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=+controle_lista_netflix&table=movies">` controle_lista_netflix`.`movies`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6f6f233c5d4b6a38725c342c42325a67">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb=" controle_lista_netflix" targettable="movies">
            ...
            Database
                            : <span> controle_lista_netflix</span>
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `movies` (`type`, `name`, `total_ep`, `atual_ep`, `last_view`) VALUES (0, &#039;Meu Malvado Favorito 2&#039;, NULL, NULL, CURRENT_TIMESTAMP()), (0, &#039;Enola Holmes&#039;, NULL, NULL, CURRENT_TIMESTAMP()), (1, &#039;Sweet Tooth&#039;, 8, 1, CURRENT_TIMESTAMP()), (0, &#039;Warcraft - O primeiro encontro de dois mundos&#039;, NULL, NULL, CURRENT_TIMESTAMP());</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb=" controle_lista_netflix" targettable="movies">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `movies` WHERE (`movies`.`id` = 1) OR (`movies`.`id` = 2) OR (`movies`.`id` = 3) OR (`movies`.`id` = 4) OR (`movies`.`id` = 5)   </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb=" controle_lista_netflix" targettable="movies">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `movies`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="movies-controll" targettable="movies">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
